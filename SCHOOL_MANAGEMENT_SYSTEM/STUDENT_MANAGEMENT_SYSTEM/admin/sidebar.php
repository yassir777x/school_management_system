    ...
    <ul class="menu_list">
        <li class="menu_items" id="dashboard">
            <div class="sub_menu active" data-id="dashboard">
                <a href="./dashboard.php" class="left_sub_menu">
            ...
            <div class="sub_menu_wrapper">
                <ul class="sub_menu_items">
                    <li class="sub_menu_item">
                        <a href="./addstudent.php" class="link_to_page" data-id="1">
                            Add Student
                        </a>
                    </li>
                    <li class="sub_menu_item">
                        <a href="./allstudent.php" class="link_to_page" data-id="2">
                            Show All Student
                        </a>
                    </li>
                </ul>
        ...
        <li class="menu_items" id="teacher">
            ...
            <div class="sub_menu_wrapper">
                <ul class="sub_menu_items">
                    <li class="sub_menu_item">
                        <a href="./addteacher.php" class="link_to_page" data-id="1">
                            Add Teacher
                        </a>
                    </li>
                    <li class="sub_menu_item">
                        <a href="./allteacher.php" class="link_to_page" data-id="2">
                            Show All Teachers
                        </a>
                    </li>
                </ul>
        ...
        <li class="menu_items" id="class">
            ...
            <div class="sub_menu_wrapper">
                <ul class="sub_menu_items">
                    <li class="sub_menu_item">
                        <a href="./addclass.php" class="link_to_page" data-id="1">
                            Add Class
                        </a>
                    </li>
                    <li class="sub_menu_item">
                        <a href="./allclass.php" class="link_to_page" data-id="2">
                            Show All Classes
                        </a>
                    </li>
                </ul>
        ...
        <li class="menu_items" id="subjects">
            ...
            <div class="sub_menu_wrapper">
                <ul class="sub_menu_items">
                    <li class="sub_menu_item">
                        <a href="./addsubject.php" class="link_to_page" data-id="1">
                            Add Subject
                        </a>
                    </li>
                    <li class="sub_menu_item">
                        <a href="./allsubject.php" class="link_to_page" data-id="2">
                            Show All Subject
                        </a>
                    </li>
                </ul>
        ...
        <li class="menu_items" id="settings">
            ...
            <div class="sub_menu_wrapper">
                <ul class="sub_menu_items">
                    <li class="sub_menu_item">
                        <a href="./schoolsettings.php" class="link_to_page" data-id="1">
                            School Settings
                        </a>
                    </li>
                    <li class="sub_menu_item">
                        <a href="./adminsettings.php" class="link_to_page" data-id="2">
                            Admin Settings
                        </a>
                    </li>
                </ul>
